<h1>WPSSO Organization Markup to Customize Schema WebSite and Manage Additional Organizations</h1>

<table>
<tr><th align="right" valign="top" nowrap>Plugin Name</th><td>WPSSO Organization Markup</td></tr>
<tr><th align="right" valign="top" nowrap>Summary</th><td>WPSSO Core add-on to customize the home page Schema WebSite markup and manage additional Schema Organizations (publishers, etc.).</td></tr>
...
<p><strong>Customize the Schema WebSite markup for your home page:</strong></p>
...
<p>Select an optional place / location / address for your home page and/or each additional Organization.</p>
